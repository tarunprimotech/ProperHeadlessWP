...
function BlogPageContent({ recent, trending, all, featuredArticles, latestArticles }: any) {
...
const paginatedPosts = all.slice(indexOfFirstPost, indexOfLastPost);

// Total pages
const totalPages = Math.ceil(all.length / postsPerPage);
